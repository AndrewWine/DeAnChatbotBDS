...
def filter_data_update(tag_from_file):
    import os


    with open(os.path.join('fileScrapped/' + tag_from_file + '.txt'), 'r', encoding='utf-8') as file:
    ...
    with open('DataJson/data.json', 'w', encoding='utf-8') as data:
        ...
        print("Dữ liệu đã được thêm vào tag" + tag_from_file)
